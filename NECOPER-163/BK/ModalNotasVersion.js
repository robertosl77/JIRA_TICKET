    ...
    <>
      ...
      >
        ...
        <ModalBody>
          ...
          <h5>1.30.0:</h5>
          <br />
          - Modificaciones en las fechas y horas del Fin Manual: se corrige error, permitiendo configurar la fecha de fin manual.
          <br />
          - Error en la carga de documentos Modulos FAE de GELEC, resuelto.
          <br />
          - Error al realizar un doble clic en la fecha/hora de fin manual, si se realizaba despues de las 22 hs, el mismo tomaba la fecha del dia siguiente. 
          <br />
          - Modulo FAE, se nivelo la base de datos, quitando marcas "posee fae" a quien no le corresponde y colocando dicha marca a quien si corresponde. 
          <br />
          - Modulo FAE, se modifico proceso para que al momento de agregar una FAE, se coloque la marca "posee fae" y la quite si el cliente ya no posee fae.
          <br />
          - No guarda la fecha y hora de documentos ya cerrados: se modifico el proceso para al momento de aplicar la baja a un documento, aquellos clientes que no estaban con estados: normalizado, con suministro o cancelado, les coloque la fecha de fin. 
          <br />
          -  No guarda la fecha y hora de documentos ya cerrados: se nivelo la base de datos para que complete con la fecha de fin aquellos clientes historicamente afectados que quedaron con fecha de fin nula. 
          <h5>1.29.6:</h5>
          <br />
