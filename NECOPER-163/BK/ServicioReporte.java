...
public class ServicioReporte implements IServicioReporte {
	...
	public byte[] reporteCliSinTel(Map<String, String> dto) throws IOException {
		...
		headerRow.createCell(1).setCellValue("TEL_ID");
		headerRow.createCell(2).setCellValue("TEL_NRO");
		headerRow.createCell(3).setCellValue("CANT_LLAMADAS");
		headerRow.createCell(4).setCellValue("CANT_EFECTIVAS");
		headerRow.createCell(5).setCellValue("ULTIMO_CONTACTO_EFECTIVO");
		headerRow.createCell(6).setCellValue("ESTADO_TELEFONO");
		headerRow.createCell(7).setCellValue("ESTADO_CLIENTE");
