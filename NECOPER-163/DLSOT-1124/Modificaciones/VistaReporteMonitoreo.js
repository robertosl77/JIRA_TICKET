...
class VistaReporteMonitoreo extends React.Component {
  ...
  async procesarReporte() {
    ...
    //23/08/2022 rsleiva: si no se completan las fechas ini y fin, toma por defecto las de hoy. 
    //formato de fecha dd/mm/yyyy ej 01/08/2022
          ...
          <Form className="pl-3 pt-4 bg-white">
            <Row form>
              <Col sm={4}>
                <FormGroup className="">
                  ...
                  >
                    ...
                    <option>Clientes_Sin_Tel</option>
                    <option>Clientes_Sin_Contacto</option>
              ...
              <Col sm={4} hidden={
                            ...
                            || this.state.tipoReporte === "Clientes_Sin_Tel"
                            || this.state.tipoReporte === "Clientes_Sin_Contacto"
                            }>
                <FormGroup>
                  <Label>
