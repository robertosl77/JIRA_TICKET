...
public class ReporteControlador {
  ...
  public ResponseEntity<?> exportarReporte(@RequestParam Map<String,String> dto) throws IOException {
		...
		case "llamadas":
			...
			break;
		case "clientes_sin_tel":
			// 19/08/2022 rsleiva se agrega el reporte Clientes Sin Tel
			res = servicioReporte.reporteCliSinTel(dto);
			break;
		case "clientes_sin_contacto":
			// 23/08/2022 rsleiva se agrega el reporte Clientes Sin Contacto
			res = servicioReporte.reporteCliSinContacto(dto);
			break;
		default:
			break;
		}
