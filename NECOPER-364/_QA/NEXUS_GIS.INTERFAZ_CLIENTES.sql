...
--  ******************************************************************************************/
    ...
    *  v_client.custatt24 se actualiza utilizando streetname guardados en variables v_calle1, v_calle2, donde streetid = v_client.streetid1
	...
	21/09/2023 RSLEIVA NECOPER-364 - se modifica el procedimiento "procesar_novedades_utc" 
		*encerrando el pasaje de telefono dentro de un begin/exception ya que se ingresan valores que superan el limite permitodo generando error. 
		*en caso de que se genere error se modifica el valor de la variable "v_client.telephonenumber" truncando a 20.
   */
