...
BEGIN
	...
	dbms_output.put_line('CUENTA|PACIENTE|DIRECCION|MEDIDOR|REGION|ZONA|CT|SERIE|POTENCIA|CAPACIDAD|INSTALACION|RETIRO|NRO_ORDEN|TIPO|USUARIO|RESPONSABLE|INICIO|FIN|ESTADO|ABONADA|FECHA_ABONADA');
	...
	for fae in repo_fae loop
		begin                        
				DBMS_OUTPUT.PUT_LINE(
					...
					fae.nro_orden|| '|' ||fae.tipo|| '|' ||fae.usuario|| '|' ||fae.grupo|| '|' ||fae.inicio|| '|' ||fae.fin|| '|' ||fae.estado|| '|' ||
