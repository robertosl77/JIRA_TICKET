...
DATE=$( date +%d%m%y%H%M )
FILE_LOG=$LOG_DIR/SOT-8414_1_NuncaFAEConMarca.ksh_$DATE.log
FILE_AUX=$LOG_DIR/SOT-8414_1_NuncaFAEConMarca.ksh.log
...
--Aquellos clientes que nunca solicitaron FAE y tienen marca de "posee fae" se quitaran. 
----------------------------
/* Formatted on 09/08/2022 09:30 (QP5 v5.294) */
DECLARE
