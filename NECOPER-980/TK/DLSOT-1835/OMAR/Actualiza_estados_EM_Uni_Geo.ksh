...
--3  
  ...
  IS
    select emu.objectid objectid_u,linkvalue valid_code_u,sprid sprid_u,normalstate normalstate_u,realstate realstate_u 
    from NEXUS_GIS.NUG_EM_unifilar emu
...
--8  
  ...
  IS 
     select objectid,linkvalue valid_code,sprid,normalstate,realstate
        from NEXUS_GIS.NUG_EM_unifilar emu
        where id_periodo = pid_per and emu.id_tipo=2
        and valid_code=p_valid_code;
--9  
...
--10  
  ...
  IS
    select emu.objectid objectid_u,linkvalue linkvalue_u,sprid sprid_u,normalstate normalstate_u,realstate realstate_u 
    from NEXUS_GIS.NUG_EM_unifilar emu
